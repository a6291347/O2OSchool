...
public class ProductDaoTest extends BaseTest {
	...
	public void testAInsertProduct() throws Exception {
		...
		product1.setProductName("ai1");
		product1.setProductDesc("ai1");
		product1.setImgAddr("ai1");
		...
		product2.setProductName("ai2");
		product2.setProductDesc("ai2");
		product2.setImgAddr("ai2");
		...
		product3.setProductName("ai3");
		product3.setProductDesc("ai3");
		product3.setImgAddr("ai3");
