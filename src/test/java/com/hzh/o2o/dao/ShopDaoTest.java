...
public class ShopDaoTest extends BaseTest {
	...
	public void testInsertShop() {
		...
		shop.setShopName("测试的店铺hzh");
		shop.setShopDesc("testhzh");
		shop.setShopAddr("testhzh");
		shop.setPhone("testhzh");
		shop.setShopImg("testhzh");
	...
	public void testUpdateShop() {
		Shop shop = new Shop();
		shop.setShopId(39L);
		shop.setShopDesc("测试描述hzh");
		shop.setShopAddr("测试地址hzh");
